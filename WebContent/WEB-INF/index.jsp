...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Passbook
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="./passbook/passbookList.do">List</a></a></li>
          <li><a href="./passbook/passbookSelect.do">Select</a></li>
